...
//    jdbc:mariadb:loadbalance://10.22.33.44:3306,10.22.33.55:3306/MariaDB?characterEncoding=UTF-8
    ...
    public DatabaseInfo parse(String jdbcUrl) {
        ...
        if (type == null) {
            logger.info("jdbcUrl has invalid prefix.(url:{}, valid prefixes:{}, {})", jdbcUrl, DB2_URL_PREFIX, MYSQL_URL_PREFIX);
            return UnKnownDatabaseInfo.INSTANCE;
        }
        ...
        try {
            ...
            return UnKnownDatabaseInfo.createUnknownDataBase(SampleConstants.DB2,SampleConstants.DB2_EXECUTE_QUERY, jdbcUrl);
        }
    }
    ...
    private DatabaseInfo parseNormal(String url, Type type) {
        ...
        return new DefaultDatabaseInfo(SampleConstants.DB2, SampleConstants.DB2_EXECUTE_QUERY, url,
